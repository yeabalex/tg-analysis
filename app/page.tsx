      ...
      <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden pb-24 selection:bg-[#FF6B00]/30 max-w-md mx-auto w-full relative">
        ...
        <div className="px-4 pt-6 space-y-8 relative z-10">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gradient-to-br from-blue-500/20 to-indigo-600/20 border border-blue-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square relative col-span-2">
              ...
              <div className="bg-emerald-500/20 border border-emerald-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-emerald-400 text-lg tracking-tight">Usefulness</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.goodTraits.usefulness.score}</div><div className="text-xs text-blue-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.goodTraits.usefulness.description}</div></div>
              <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-yellow-400 text-lg tracking-tight">Funny</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.goodTraits.funny.score}</div><div className="text-xs text-blue-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.goodTraits.funny.description}</div></div>
              <div className="bg-cyan-500/20 border border-cyan-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-cyan-400 text-lg tracking-tight">Cool</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.goodTraits.cool.score}</div><div className="text-xs text-blue-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.goodTraits.cool.description}</div></div>
              <div className="bg-pink-500/20 border border-pink-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-pink-400 text-lg tracking-tight">Positivity</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.goodTraits.positivity.score}</div><div className="text-xs text-blue-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.goodTraits.positivity.description}</div></div>
              <div className="bg-indigo-500/20 border border-indigo-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-indigo-400 text-lg tracking-tight">Aura</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.goodTraits.aura.score || '?'}</div><div className="text-xs text-blue-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.goodTraits.aura.description}</div></div>
              <div className="bg-teal-500/20 border border-teal-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-teal-400 text-lg tracking-tight">Based Level</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.goodTraits.basedLevel.score || '?'}</div><div className="text-xs text-blue-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.goodTraits.basedLevel.description}</div></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gradient-to-br from-red-500/20 to-red-700/20 border border-red-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square col-span-2">
              ...
              <div className="bg-orange-500/20 border border-orange-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-orange-400 text-lg tracking-tight">Yap Level</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.spicyTraits.yapLevel.score}</div><div className="text-xs text-red-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.spicyTraits.yapLevel.description}</div></div>
              <div className="bg-purple-500/20 border border-purple-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-purple-400 text-lg tracking-tight">Ego Level</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.spicyTraits.egoLevel.score}</div><div className="text-xs text-red-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.spicyTraits.egoLevel.description}</div></div>
              <div className="bg-fuchsia-500/20 border border-fuchsia-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-fuchsia-400 text-lg tracking-tight">Chaos</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.spicyTraits.chaosLevel.score}</div><div className="text-xs text-red-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.spicyTraits.chaosLevel.description}</div></div>
              <div className="bg-rose-500/20 border border-rose-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square"><span className="font-bold text-rose-400 text-lg tracking-tight">Overconfident</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.spicyTraits.overconfidence.score}</div><div className="text-xs text-red-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.spicyTraits.overconfidence.description}</div></div>
              <div className="bg-violet-500/20 border border-violet-500/30 rounded-[2rem] p-5 flex flex-col justify-between aspect-square col-span-2"><span className="font-bold text-violet-400 text-lg tracking-tight">Delusional</span><div className="text-[4rem] font-black tracking-tighter leading-none text-white">{r.spicyTraits.delusionLevel.score || '?'}</div><div className="text-xs text-red-300/80 mt-1 font-bold leading-tight line-clamp-2">{r.spicyTraits.delusionLevel.description}</div></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-[#151515] rounded-3xl p-5 border border-white/10"><div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1">Framework</div><div className="text-lg font-black text-purple-400 mb-1">{r.ifTheyWere.framework.name}</div><div className="text-xs text-gray-400 line-clamp-3">{r.ifTheyWere.framework.description}</div></div>
            <div className="bg-[#151515] rounded-3xl p-5 border border-white/10"><div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1">Browser</div><div className="text-lg font-black text-emerald-400 mb-1">{r.ifTheyWere.webBrowser.name}</div><div className="text-xs text-gray-400 line-clamp-3">{r.ifTheyWere.webBrowser.description}</div></div>
            <div className="bg-[#151515] rounded-3xl p-5 border border-white/10"><div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1">Football Club</div><div className="text-lg font-black text-rose-400 mb-1">{r.ifTheyWere.footballClub.name}</div><div className="text-xs text-gray-400 line-clamp-3">{r.ifTheyWere.footballClub.description}</div></div>
            <div className="bg-[#151515] rounded-3xl p-5 border border-white/10"><div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-1">Villain</div><div className="text-lg font-black text-yellow-400 mb-1">{r.ifTheyWere.movieVillain.name}</div><div className="text-xs text-gray-400 line-clamp-3">{r.ifTheyWere.movieVillain.description}</div></div>
          </div>
                ...
                {leaderboards.topLanguages.map((item: any, i: number) => {
                  ...
                  return (
                    <div
                      ...
                      className={`cursor-pointer rounded-[2rem] p-5 flex flex-col justify-between relative overflow-hidden transition-all duration-300 shadow-lg ${isExpanded ? 'col-span-2 aspect-auto min-h-[160px]' : 'aspect-square'} ${i === 0 ? 'bg-gradient-to-br from-[#FF6B00] to-[#ff3300] text-black border-none' : 'bg-[#151515] text-white border border-white/5 hover:border-white/20'}`}
                    >
